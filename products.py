...
PRODUCTS = {
    'classic-peanut': {
        ...
        'image': 'images/packs/classic-peanut.png',
        'color': '#7B3FF2',
        'color_name': 'peanut',
        'text_color': '#FFE600',
        'on_color': '#FFE600',
    ...
    'coco-crunch': {
        ...
        'image': 'images/packs/coco-crunch.png',
        'color': '#00A19A',
        'color_name': 'coco',
        'text_color': '#FF3DAA',
        'on_color': '#FF3DAA',
    ...
    'choco-fudge': {
        ...
        'image': 'images/packs/choco-fudge.png',
        'color': '#FF6A1A',
        'color_name': 'choco',
        'text_color': '#FFFFFF',
        'on_color': '#FFFFFF',
    ...
    'salted-caramel': {
        ...
        'image': 'images/packs/salted-caramel.png',
        'color': '#EC2C8A',
        'color_name': 'caramel',
        'text_color': '#FFE600',
        'on_color': '#FFE600',
    ...
    'cookies-cream': {
        ...
        'image': 'images/packs/cookies-cream.png',
        'color': '#1F4FE0',
        'color_name': 'cookies',
        'text_color': '#FF6A1A',
        'on_color': '#FF6A1A',
    ...
    'pista-crunch': {
        ...
        'image': 'images/packs/pista-crunch.png',
        'color': '#B8DC2A',
        'color_name': 'pista',
        'text_color': '#7B3FF2',
        'on_color': '#7B3FF2',
